...
{
    public class CSharpClientMessageParser
    {
        ...
        {
            ProtoGroup protoGroup = protoConfig.S2CGroup;
        ...
        {
            writer.WriteLine($"{GetIndent(indent)}public static void RegisterParser(Dot.Net.Client.ClientNet clientNet)");
            writer.WriteLine($"{GetIndent(indent)}{{");
            ++indent;
        }
